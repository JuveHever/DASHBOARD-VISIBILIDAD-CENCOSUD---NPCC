...
- **Ficha por almacén** — una foto por tipo de exhibición presente, con su etiqueta,
  más número de visitas y fecha de la última.
...
Y con ello, **una sola foto por tipo**: la más reciente. En campo se fotografía el mismo
mueble en cada visita, así que las repeticiones no aportan información nueva.

Ejemplo: JUMBO RIONEGRO acumulaba 50 fotos en 10 visitas. El dashboard muestra
**4 exhibiciones con 4 fotos** — Balconera, Ristra, Espacio adicional y Chimenea.
El visor indica en cuántas visitas se registró cada una, para no perder ese rastro.
  ...
  "pdvs": [
    {
      ...
      "visitas": 10, "nFotos": 4, "ultimaVisita": "27/07/2026", "nTipos": 4,
      "nCapturasFoto": 50,          // fotos tomadas en campo (antes de deduplicar)
      "tipos": [
        {
          "tipo": "Balconera",
          "nCapturas": 20,          // veces que se registró en campo
          "foto": { "cod": "...", "url": "https://...", "fecha": "...", "raw": "balconera", "ruta": "..." }
        }
      ]
    }
  ]
